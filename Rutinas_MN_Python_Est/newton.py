...
@Autores: Gustavo Pérez, Manuela Bastidas


Método de Newton-Raphson: 
    
El método de Newton-Raphson para encontrar una raíz de la función f.
...
Retorna:
- p0(float): Una aproximación de la raíz.
...
def newton(f, df, p0, tol, max_iter):
